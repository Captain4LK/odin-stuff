...
* First, clone this repository: ``https://github.com/Captain4LK/odin-stuff``

## Dependencies

In order to compile img2pixel, you'll need a copy of the odin compiler: https://odin-lang.org/docs/install/ . If you follow the instructions there, you should have everything needed to build.
...
* cd into img2pixels directory: ``cd img2pixel``
* then compile: ``odin build . -o:speed``
* the binary should be located in the current director
...
* ported to SDL3
* added support for automatically refreshing input images upon them being updated
